            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">bugslayers@healthcare.ai</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">+1 (555) LIFE-SAVE</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">Tech Innovation Campus<br />Healthcare Valley, CA</div>
                </div>
              </div>
            </div>
